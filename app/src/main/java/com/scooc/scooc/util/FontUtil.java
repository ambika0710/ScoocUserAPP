...
import com.scooc.scooc.config.TypefaceCache;
        ...
        if (fontName.contentEquals(App.getInstance().getString(R.string.font_roboto))) {
            switch (textStyle) {
                ...
                case Typeface.ITALIC: // italic
                    return TypefaceCache.getInstance().getTypeface(App.getInstance().getString(R.string.font_roboto_condensed_italic));
                case Typeface.BOLD_ITALIC: // bold italic
                    return TypefaceCache.getInstance().getTypeface(App.getInstance().getString(R.string.font_roboto_condensed_bold_italic));
