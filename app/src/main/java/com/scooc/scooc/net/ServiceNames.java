...
public class ServiceNames {
    ...
    /*Set BASE URL here*/
        private static final String PRODUCTION_API = "http://www.scooc.in";
  ...
  //  public static final String PATH_UPLOADS = "/lataxi/";  // line removed for image not fetching
...
//    public static final String CAR_LIST = "http://demo8142432.mockable.io/carlist?";
    ...
    public static final String Check_Phone_Number = API + "/check_phone_number?";
    public static final String Update_Password = API + "/forgot_password_otp?";
}
