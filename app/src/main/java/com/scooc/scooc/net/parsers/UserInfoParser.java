package com.scooc.scooc.net.parsers;
            ...
            if (jsonObj.has("data")) {
                ...
                if (dataJSObject != null) {
                    try {
                        ...
                        if (dataJSObject.has("gender")) {
                            userBean.setGender(dataJSObject.optString("gender"));
                        }
                        if (dataJSObject.has("dob")) {
                            userBean.setDob(dataJSObject.optString("dob"));
                        }
