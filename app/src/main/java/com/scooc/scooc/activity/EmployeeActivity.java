...
/*    private boolean checkForTableExists(SQLiteDatabase db, String table){
    ...
    private boolean isDbPresent() {
       ...
       SQLiteDatabase mDatabase;
        ...
        String testPath = context.getDatabasePath(RecurringRidesActivity.DATABASE_NAME) + RecurringRidesActivity.DATABASE_NAME;
        try{
 ...
 /*   private boolean checkDataBase() {
    ...
    private void showEmployeesFromDatabase() {
        mDatabase = openOrCreateDatabase(RecurringRidesActivity.DATABASE_NAME, MODE_PRIVATE, null);

        Cursor cursorEmployees = mDatabase.rawQuery("SELECT * FROM recurringtable", null);
