...
import com.scooc.scooc.listeners.LocationUpdateListener;
import com.scooc.scooc.listeners.PermissionListener;
...
import com.scooc.scooc.net.WSAsyncTasks.FCMRegistrationTask;
import com.scooc.scooc.net.WSAsyncTasks.LocationNameTask;
import com.scooc.scooc.net.WSAsyncTasks.LocationTask;
import com.scooc.scooc.util.AppConstants;


public class RecurringRidesActivity extends BaseAppCompatActivity implements
    ...
    public static final String DATABASE_NAME = "recurringdb";
    ...
    public static String pickup_time, start_date, end_date;
    public static final String NOTIFICATION_CHANNEL_ID = "10001";
    private final static String default_notification_channel_id = "default";
    public Menu mMenu;
    Date currentTime = Calendar.getInstance().getTime();
    String currentTimeNEW = new SimpleDateFormat("HH:mm", Locale.getDefault()).format(new Date());
    String checktime = "19:13";
    TextView chooseTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recurring_page);
...
//        getData();
        ...
        viewAll();
        createChannel(
                getString(R.string.lataxi_notification_channel_id),
                getString(R.string.lataxi_notification_channel_name)
        );
        // call();
    }
...
// (ID INTEGER PRIMARY KEY AUTOINCREMENT,SOURCE TEXT,DESTINATION TEXT,PICKUPTIME TEXT,STARTDATE TEXT,ENDDATE TEXT,MULINTENT INTEGER)");
//}
private void createEmployeeTable() {
    mDatabase.execSQL(

            "CREATE TABLE IF NOT EXISTS recurringtable (\n" +
...
/*    public void call ()
    {
        if (currentTimeNEW.equals(checktime))
        {
            scheduleNotification(getNotification( "5 second delay" ) , 5000 ) ;

        }
        else{
            Toast.makeText(LandingPageActivity.this,"sorry", Toast.LENGTH_LONG).show();        }
    }*/
...
//            createLocationRequest();
    ...
    // mdob_et.setInputType(InputType.TYPE_NULL);
    public void endDateclick() {
        ...
        enddate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                picker = new DatePickerDialog(RecurringRidesActivity.this,
...
*/
                                ...
                                sharedPreferenceHelper.setEndDateDay(dayOfMonth);
                                sharedPreferenceHelper.setEndDateMonth(monthOfYear);
                                sharedPreferenceHelper.setEndDateYear(year);
...
*/
                                ...
                                sharedPreferenceHelper.setStartDateYear(year);
                ...
                //ToDo
                start_date = mdob_et.getText().toString();
    ...
    public void timeclick() {
        chooseTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                timePickerDialog = new TimePickerDialog(RecurringRidesActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker timePicker, int hourOfDay, int minutes) {
                        ...
                        sharedPreferenceHelper.setTimeHour(hourOfDay);
                        sharedPreferenceHelper.setTimeMinute(minutes);
                ...
                //ToDo
                pickup_time = chooseTime.getText().toString();
    ...
    private void addRidebtnClick() {
        add_ride.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mdob_et.setText("");
                enddate.setText("");
             /*   if (txtDestination.getText().length() == 0 && chooseTime.getText().length()==0 &&mdob_et.getText().length()==0&& enddate.getText().length()==0 ) {
                    ...
                    Toast.makeText(RecurringRidesActivity.this,"Your recurring Rides are booked ", Toast.LENGTH_SHORT).show();
   ...
   /*     String name = editTextName.getText().toString().trim();
        ...
        String des = txtDestination.getText().toString();
        ...
        //validating the inptus
            ...
            String insertSQL = "INSERT INTO recurringtable \n" +
...
/*
                        ...
                        //this time it has two parameters
                        //first is the sql string and second is the parameters that is to be binded with the query
                        mDatabase.execSQL(insertSQL, new String[]{txtSource.getText().toString(), txtDestination.getText().toString(),
                                chooseTime.getText().toString(),
                                mdob_et.getText().toString(),
        ...
        btnviewAll.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(RecurringRidesActivity.this, EmployeeActivity.class);
    ...
    private void sampleBtnclick() {
        sampleBtn.setOnClickListener(new View.OnClickListener() {
            String checkdestinationvalue = txtDestination.getText().toString();
            String chooseTimecheck = chooseTime.getText().toString();
            String startdatecheckvalue = mdob_et.getText().toString();
            ...
            if (chooseTime.getText().length() == 0){
                Snackbar.make(coordinatorLayout,"Pickuptime is Required",Snackbar.LENGTH_SHORT).setAction(R.string.btn_refresh,snackBarRefreshOnClickListener).show();
            }
            else
            if (mdob_et.getText().length() == 0){
                Snackbar.make(coordinatorLayout,"StartDate is Required",Snackbar.LENGTH_SHORT).setAction(R.string.btn_refresh,snackBarRefreshOnClickListener).show();
            }
            else
            if (enddate.getText().length() == 0){
                Snackbar.make(coordinatorLayout,"Enddate is Required",Snackbar.LENGTH_SHORT).setAction(R.string.btn_refresh,snackBarRefreshOnClickListener).show();
            }
    ...
    private void cancelPendingIntent() {
        ...
        Intent updateServiceIntent = new Intent(getApplication(), AlarmReceiver.class);
        PendingIntent pendingUpdateIntent = PendingIntent.getService(getApplication(), REQUEST_CODE_PENDING_INTENT, updateServiceIntent,
    ...
    static int multipe_intent = 199;

    public void sample() {
     //   for (int i = 0; i < 10; ++i) {
        Intent notifyIntent = new Intent(App.getInstance(), AlarmReceiver.class);
        notifyIntent.putExtra("extravalue",multipe_intent);
    ...
    /*    ArrayList<PendingIntent> intentArray = new ArrayList<PendingIntent>();
        for (int i = 0; i < 10; ++i) {
            ...
            intentArray.add(notifyPendingIntent);*/
      /*
...
//Setting alarm pending intent
            ...
            /*long calenderAlarm = SystemClock.elapsedRealtime() + 1_000L * 10;*/

            NotificationManager notificationManager = ContextCompat.getSystemService(
                    getApplication(),
                    NotificationManager.class);
            NotificationUtilsKt.cancelNotifications(notificationManager);

            Calendar calenderAlarm = Calendar.getInstance();
            //calenderAlarm.setTimeInMillis(System.currentTimeMillis());

            calenderAlarm.set(Calendar.YEAR, sharedPreferenceHelper.getStartDateYear());
            calenderAlarm.set(Calendar.MONTH, sharedPreferenceHelper.getStartDateMonth());
            calenderAlarm.set(Calendar.DAY_OF_MONTH, sharedPreferenceHelper.getStartDateDay());

            calenderAlarm.set(Calendar.AM_PM, Calendar.AM);
            calenderAlarm.set(Calendar.HOUR, sharedPreferenceHelper.getTimeHour());

            if (sharedPreferenceHelper.getTimeHour() >= 12) {
                calenderAlarm.set(Calendar.AM_PM, Calendar.PM);
                calenderAlarm.set(Calendar.HOUR, sharedPreferenceHelper.getTimeHour() - 12);
            }
            calenderAlarm.set(Calendar.MINUTE, sharedPreferenceHelper.getTimeMinute());
            calenderAlarm.set(Calendar.SECOND, 0);

            AlarmManagerCompat.setExactAndAllowWhileIdle(
                    alarmManager,
                    AlarmManager.RTC_WAKEUP,
                    calenderAlarm.getTimeInMillis(),
                    notifyPendingIntent
            );
                multipe_intent = multipe_intent+100;
     //   }
    }
    ...
    private void createChannel(String channelId, String channelName) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            notificationChannel.setDescription("Book your ride by clicking Book");
    ...
    /*public void DateDialog(){
        ...
        DatePickerDialog dpDialog=new DatePickerDialog(LandingPageActivity.this, listener, year, month, day);
        dpDialog.show();
    }*/
...
//        displayLocation();
    ...
    public void onFareEstimateClick(View view) {
        ...
        Intent intent = new Intent(RecurringRidesActivity.this, SearchPageActivity.class);
...
//        center = mMap.getProjection().getVisibleRegion().latLngBounds.getCenter();
        ...
        if (!isConfirmationPage) {
            ...
            txtActionSearch.setText("Book Your Scooc");
...
//        center = mMap.getProjection().getVisibleRegion().latLngBounds.getCenter();
        ...
        DataManager.fetchCarAvailability(urlParams, new CarInfoListener() {
            ...
            public void onLoadFailed(String error) {
                ...
                Toast.makeText(RecurringRidesActivity.this, error, Toast.LENGTH_SHORT).show();
    ...
    public void fetchTotalfare() {
        ...
        DataManager.fetchTotalFare(urlParams, new TotalFareListener() {
            ...
            public void onLoadFailed(String error) {
                ...
                if (!isFinishing()) {
                    PopupMessage popupMessage = new PopupMessage(RecurringRidesActivity.this);
            ...
            if (carBean.getCarsAvailable().equalsIgnoreCase(getString(R.string.label_no_cars_available)) && txtDestination.getText().length() != 0) {
                ...
                if (txtDestination.getText().length() == 0) {
                    ...
                    if (fareBean != null && sourceBean != null && destinationBean != null) {
                        ...
                        Intent intent = new Intent(RecurringRidesActivity.this, RequestingPageActivity.class);
                        intent.putExtra("fare_bean", fareBean);
                        intent.putExtra("car_type", String.valueOf(carType));
                        intent.putExtra("pickup_time", pickup_time);
                        intent.putExtra("start_date", String.valueOf(start_date));
                        intent.putExtra("end_date", String.valueOf(end_date));
...
//        }
        ...
        DataManager.fetchPolyPoints(urlParams, new PolyPointsListener() {
            ...
            public void onLoadFailed(String error) {
                swipeView.setRefreshing(false);
                Log.e(TAG, "onLoadFailed: POLYPOINTS : ");
