...
import com.scooc.scooc.util.transforms.CircleTransform;

import static com.scooc.scooc.app.App.AUTH_TOKEN_NOT_AVAILABLE;
import static com.scooc.scooc.app.App.NETWORK_NOT_AVAILABLE;
import static com.scooc.scooc.app.App.SERVER_CONNECTION_AVAILABLE;
...
//        swipeView.setRefreshing(true);
    ...
    public void onRecurring_Rides(View view) {
        view.performHapticFeedback(HapticFeedbackConstants.VIRTUAL_KEY);

        Intent intent = new Intent(BaseAppCompatActivity.this, RecurringRidesActivity.class);
        startActivity(intent);
